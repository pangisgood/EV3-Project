all: ev3dev.a sound.o h_crane.o
	arm-linux-gnueabi-g++-4.7 -L. -o sound sound.o h_crane.o -lev3dev
...
sound.o: sound.cpp
		arm-linux-gnueabi-g++-4.7 -c sound.cpp -o sound.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
