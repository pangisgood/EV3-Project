all: ev3dev.a pmev3.o h_crane.o
	arm-linux-gnueabi-g++-4.7 -L. -o pmev3 pmev3.o h_crane.o -lev3dev
...
pmev3.o: pmev3.cpp
		arm-linux-gnueabi-g++-4.7 -c pmev3.cpp -o pmev3.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
